	...
	<div class="col-lg-12">
			<div class="billing-form-item">
					<div class="billing-title-wrap">
						<div class="row">
							<div class="col-10">
								<h3 class="widget-title pb-0">Add New Lecturer</h3>
								...
								<div class="row mt-3">
									<div class="col-lg-12">
										<div class="sidebar-widget">
												<div class="billing-form-item">
														<div class="billing-title-wrap">
																<h3 class="widget-title">Create a NEw Lecturer</h3>
																...
																<form class="edit-profile m-b30" id="" method="POST" action="{{ route('admin_create_lecturer') }}">
																		...
																		<div class="">
																				...
																				<div class="form-group row mb-4">
																						...
																						<div class="col-sm-10">
																							<select class="form-control semester-option-field" id="semester_id" name="semester_id">
																								...
																								<option class="text-capitalize" {{ old('semester_id') == $semester->id ? "selected" : "" }} value="{{$semester->id}}" >{{$semester->name}}</option>                                                
																								@endforeach
																							</select>
																							@error('semester_id')
																								<span class="invalid-feedback mb-2" role="alert" style="display: block">
																				...
																				<div class="form-group row mb-4">
																						...
																						<div class="col-sm-10">
																							<select class="form-control course-option-field" id="courses_single" name="course_id" onchange="getCourse(this)">
																								...
																								<option class="text-capitalize" {{ old('course_id') == $course->id ? "selected" : "" }} value="{{$course->id}}" >{{$course->course_title}} ({{ $course->course_code }})</option>                                                
																								@endforeach
																							</select>
																							@error('course_id')
																								<span class="invalid-feedback mb-2" role="alert" style="display: block">
																				...
																				<div class="form-group row mb-4">
																						...
																						<div class="col-sm-10">
																							<input class="form-control @error('lecturer_id') is-invalid @enderror" name="lecturer_id" type="text" value="{{ old('lecturer_id') }}" placeholder="Lecturer ID">
																							@error('lecturer_id')
																								<span class="invalid-feedback mb-2" role="alert" style="display: block">
																									<strong>{{ $message }}</strong>
																								</span>
																				...
																				<div class="form-group row mb-4">
																						...
																						<div class="col-sm-10">
																							<input class="form-control @error('email') is-invalid @enderror" name="email" type="email" value="{{ old('email') }}" placeholder="Lecturer Email">
																							@error('email')
																								<span class="invalid-feedback mb-2" role="alert" style="display: block">
																									<strong>{{ $message }}</strong>
																								</span>
																				...
																				<div class="form-group row mb-4">
																						...
																						<div class="col-sm-10">
																							<input class="form-control @error('first_name') is-invalid @enderror" name="first_name" type="text" value="{{ old('first_name') }}" placeholder="Lecturer First Name">
																							@error('first_name')
																								<span class="invalid-feedback mb-2" role="alert" style="display: block">
																									<strong>{{ $message }}</strong>
																								</span>
																				...
																				<div class="form-group row mb-4">
																						...
																						<div class="col-sm-10">
																							<input class="form-control @error('last_name') is-invalid @enderror" name="last_name" type="text" value="{{ old('last_name') }}" placeholder="Lecturer Last Name">
																							@error('last_name')
																								<span class="invalid-feedback mb-2" role="alert" style="display: block">
																									<strong>{{ $message }}</strong>
																								</span>
